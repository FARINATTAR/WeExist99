...
const BlockchainVisualization = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 600 200" className="w-full h-full">
      <defs>
        ...
        <marker id="arrowhead" markerWidth="8" markerHeight="6" refX="6" refY="3" orient="auto">
          <path d="M0,0 L8,3 L0,6" fill="none" stroke="#4A90E2" strokeWidth="1" filter="url(#glow)"/>
        </marker>
      </defs>
      ...
      <path d="M120 100 L480 100" stroke="#4A90E2" strokeWidth="1" strokeDasharray="10,10">
        <animate attributeName="stroke-dashoffset" from="0" to="-20" dur="2s" repeatCount="indefinite"/>
      </path>

      <g transform="translate(40,25)">
        <rect x="0" y="0" width="100" height="150" fill="#1A1A1A" stroke="#4A90E2" strokeWidth="1.5" rx="10"/>
        <text x="50" y="40" fill="#FFFFFF" textAnchor="middle" fontSize="14" fontWeight="bold">DONATION</text>
        <text x="50" y="75" fill="#4A90E2" textAnchor="middle" fontSize="20" fontWeight="bold">$100</text>
        <text x="50" y="105" fill="#FFFFFF" textAnchor="middle" fontSize="12">Initial Block</text>
      ...
      <g transform="translate(250,25)">
        <rect x="0" y="0" width="100" height="150" fill="#1A1A1A" stroke="#4A90E2" strokeWidth="1.5" rx="10"/>
        <text x="50" y="40" fill="#FFFFFF" textAnchor="middle" fontSize="14" fontWeight="bold">VERIFIED</text>
        <text x="50" y="75" fill="#4A90E2" textAnchor="middle" fontSize="14">Processing</text>
        <text x="50" y="105" fill="#FFFFFF" textAnchor="middle" fontSize="12">Smart Contract</text>
      ...
      <g transform="translate(460,25)">
        <rect x="0" y="0" width="100" height="150" fill="#1A1A1A" stroke="#4A90E2" strokeWidth="1.5" rx="10"/>
        <text x="50" y="40" fill="#FFFFFF" textAnchor="middle" fontSize="14" fontWeight="bold">IMPACT</text>
        <text x="50" y="75" fill="#4A90E2" textAnchor="middle" fontSize="14">Delivered</text>
        <text x="50" y="105" fill="#FFFFFF" textAnchor="middle" fontSize="12">Confirmed</text>
        <path d="M35,130 L45,140 L65,120" stroke="#4A90E2" strokeWidth="3" fill="none">
      ...
      <g>
        <circle cx="0" cy="0" r="2" fill="#4A90E2">
          <animateMotion path="M120,100 L480,100" dur="3s" repeatCount="indefinite"/>
        </circle>
        <circle cx="0" cy="0" r="2" fill="#4A90E2">
          <animateMotion path="M120,100 L480,100" dur="3s" begin="1s" repeatCount="indefinite"/>
        </circle>
        <circle cx="0" cy="0" r="2" fill="#4A90E2">
          <animateMotion path="M120,100 L480,100" dur="3s" begin="2s" repeatCount="indefinite"/>
        </circle>
      </g>
    </svg>
  );
...
// Previous component code remains the same until stage 5...
